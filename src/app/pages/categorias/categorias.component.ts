...
export class CategoriasComponent implements OnInit {
  ...
  obtenerItemCategoria(id){
    this.productoService.listar_productoCat(id).subscribe(
      res => {
        this.productos = res;
  ...
  obtenerItemCategoriaName(){
    this.productoService.getProductoByCategoryName(this.nombre).subscribe(
      res => {
        this.productos = res;
        console.log(res);
      }
